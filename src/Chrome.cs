...
namespace TinyTodo
{
    ...
    internal class AppWindow : Form
    {
        ...
        { var b = new FloatingSwitch { AccessibleName = "窗口／悬浮模式" }; b.Changed = changed; captionActions.Add(b); Controls.Add(b); PerformLayout(); return b; }
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            ...
            for (int i = captionActions.Count - 1; i >= 0; i--) { int w = captionActions[i] is FloatingSwitch ? Ui.U(62) : side; next -= w + Ui.U(4); captionActions[i].SetBounds(next, y, w, side); captionActions[i].BringToFront(); }
            int size = Ui.U(18);
